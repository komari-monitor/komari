...
func static(r *gin.RouterGroup, noRoute func(handlers ...gin.HandlerFunc), forceDefaultTheme bool) {
	...
	serveIndex := func(c *gin.Context) {
		...
		if !exists {
			c.String(http.StatusNotFound, "Index file missing in embedded frontend.")
			return
		}
	...
	r.GET("/favicon.ico", func(c *gin.Context) {
		...
		// Fallback to the embedded frontend favicon.
	...
	// Keep the built-in manifest URL used by the page settings editor.
