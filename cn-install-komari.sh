...
get_download_url() {
    ...
    if [ "$CHANNEL" = "snapshot" ]; then
        ...
        echo "https://github.fryfries13.cn/https://github.com/${REPO}/releases/download/${latest_snapshot}/${file_name}"
    else
        # 稳定版：使用 latest
        echo "https://github.fryfries13.cn/https://github.com/${REPO}/releases/latest/download/${file_name}"
    fi
}
